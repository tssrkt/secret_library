...
export const ZIP_MAX_BOOK_ENTRY_SIZE = 128 * 1024 * 1024;
...
export const BOOK_SOURCE_TYPES = Object.freeze(['fb2', 'zip', 'epub', 'mobi']);
export const EPUB_CONTAINER_BYTES = 256 * 1024;
export const EPUB_PACKAGE_BYTES = 2 * 1024 * 1024;
export const BOOK_PREVIEW_BYTES = 512 * 1024;
export const BOOK_COVER_BYTES = 8 * 1024 * 1024;
export const EPUB_PREVIEW_DOCUMENTS = 5;
export const MOBI_HEADER_BYTES = 2 * 1024 * 1024;
export const MOBI_MAX_RECORDS = 65535;
