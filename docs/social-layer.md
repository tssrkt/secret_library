...
Полный индекс, FB2, книги, обложки и настройки excludedFolderIds остаются в Google Drive. Share обозначает доступ ко всем папкам, разрешённым общей настройкой владельца. Для вкладок друзей добавлена читаемая проекция разрешённого каталога в существующем Firestore; см. [переключение библиотек](library-tabs.md). Drive permissions не меняются.
